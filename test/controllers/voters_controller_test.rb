...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { cnic: @voter.cnic, fingerprint: @voter.fingerprint, name: @voter.name } }
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { cnic: @voter.cnic, fingerprint: @voter.fingerprint, name: @voter.name } }
