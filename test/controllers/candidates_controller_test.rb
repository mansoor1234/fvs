...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference('Candidate.count') do
      post candidates_url, params: { candidate: { cnic: @candidate.cnic, name: @candidate.name, polling_id: @candidate.polling_id } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { cnic: @candidate.cnic, name: @candidate.name, polling_id: @candidate.polling_id } }
